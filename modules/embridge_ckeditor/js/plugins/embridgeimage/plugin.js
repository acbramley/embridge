...
(function ($, Drupal, CKEDITOR) {
  ...
  CKEDITOR.plugins.add('embridgeimage', {
    ...
    beforeInit: function (editor) {
      ...
      editor.on('widgetDefinition', function (event) {
        ...
        // for extending, so that both this basic embridgeimage plugin and Drupal
        ...
        // a bug in CKEditor. In the case of embridgeimage, we don't ever want to
      ...
      editor.widgets.on('instanceCreated', function (event) {
        ...
        widget.on('edit', function (event) {
          ...
          // Open embridgeimage dialog.
          editor.execCommand('editembridgeimage', {
            ...
            dialogTitle: widget.data.src ? editor.config.embridgeImage_dialogTitleEdit : editor.config.embridgeImage_dialogTitleAdd
          });
        });
      });
      ...
      if (editor.ui.addButton) {
        editor.ui.addButton('EmbridgeImage', {
          label: Drupal.t('Embridge Image'),
  ...
  /**
   * Integrates the embridgeimage widget with the drupallink plugin.
   *
  ...
  // Expose an API for other plugins to interact with embridgeimage widgets.
  CKEDITOR.plugins.embridgeimage = {
